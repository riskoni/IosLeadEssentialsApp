...
//
//  Created by Nikolay Riskov on 15.12.23.
//
...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case let .success(imageFeed)?:
            XCTAssertEqual(imageFeed.count, 8, "Expected 8 images in the test acocunt image feed")
        ...
        default:
            XCTFail("Expected a success, got no result instead")
        }
    }
