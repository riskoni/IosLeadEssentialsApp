//
//  CacheFeedUsetestCaseTests.swift
//  EssentialFeedTests
//
//  Created by Nikolay Riskov on 16.12.23.
//
...
class LocalFeedLoader {
    ...
    func cacheItems(_ items: [FeedItem], with completion: @escaping (Error?) -> Void) {
...
final class CacheFeedUsetestCaseTests: XCTestCase {
    ...
    private class FeedStoreSpy: FeedStore {
        ...
        func completeDeletionSuccessfully(_ index: Int = 0) {
        ...
        func completeInsertionSuccessfully(_ index: Int = 0) {
